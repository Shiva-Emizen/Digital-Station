                    ...
                    Builder(
                      builder: (context) {
                        if (FFAppState().userType == '0') {
                          ...
                          final clientDetails = ClientHomePageGroup.clientProfileCall.clientDetails(homePageClientProfileResponse.jsonBody);
                          final portfolioList = getJsonField(clientDetails, r'''$.portfolio''') as List<dynamic>?;
                          return Stack(
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(0.0),
