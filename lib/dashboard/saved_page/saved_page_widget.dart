              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 6.0, 20.0, 0.0),
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                    ...
                    children: [
                      FutureBuilder<ApiCallResponse>(
                        future: (_model.apiRequestCompleter ??= Completer<
                                ApiCallResponse>()
                              ..complete(
                                  ClientHomePageGroup.savedServicesCall.call(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final listViewSavedServicesResponse = snapshot.data!;

                          return Builder(
                            builder: (context) {
                              final savedList =
                                  ClientHomePageGroup.savedServicesCall
                                          .savedList(
                                            listViewSavedServicesResponse
                                                .jsonBody,
                                          )
                                          ?.toList() ??
                                      [];
