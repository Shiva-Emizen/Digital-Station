  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final homePageCopyClientProfileResponse = snapshot.data!;
                                                  ...
                                                  valueOrDefault<String>(
                                                    getJsonField(
                                                      ClientHomePageGroup
                                                          .clientProfileCall
                                                          .clientDetails(
                                                        homePageCopyClientProfileResponse
                                                            .jsonBody,
                                                      ),
                                                      r'''$.avatar''',
                                                    )?.toString(),
