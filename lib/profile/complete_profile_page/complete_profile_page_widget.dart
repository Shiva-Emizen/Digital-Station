                              ...
                              ClipRRect(
                                ...
                                child: Image.network(
                                  ...
                                  errorBuilder: (context, error, stackTrace) {
                                    return Image.asset(
                                      'assets/images/app_launcher_icon.png', // Your default image asset
                                      width: 90.0,
                                      height: 90.0,
                                      fit: BoxFit.cover,
                                    );
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FutureBuilder<ApiCallResponse>(
                              future: ClientHomePageGroup.freelancerProfileCall
                                  .call(
                                userId: widget.userId,
                                authToken: FFAppState().apitoken,
                              ),
                              builder: (context, snapshot) {
                                ...
                                final serviceList = getJsonField(
                                  ClientHomePageGroup.freelancerProfileCall
                                      .freelancerProfile(
                                    listViewFreelancerProfileResponse.jsonBody,
                                  ),
                                  r'''$.services''',
                                ).toList();
