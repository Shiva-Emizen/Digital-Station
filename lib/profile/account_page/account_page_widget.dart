                            ...
                            children: [
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context
                                        .pushNamed(OrderPageWidget.routeName);
                                  },
                                  child: Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(PaymentPageWidget.routeName);
                                },
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(LanguagePageWidget.routeName);
                                },
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                              ...
                              InkWell(
                                onTap: () async {
                                  final appDeepLink =
                                      'yourapp://home'; // Your app's deep link
                                  final playStoreUrl =
                                  ...
                                  if (await canLaunchUrl(
                                      Uri.parse(appDeepLink))) {
                                    await launchUrl(Uri.parse(appDeepLink));
                                  } else {
                                    // If app not installed, open Play Store/App Store
