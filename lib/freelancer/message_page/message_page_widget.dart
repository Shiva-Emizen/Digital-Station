...
class _MessagePageWidgetState extends State<MessagePageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultpy7 = await ClientHomePageGroup.clientProfileCall.call(
                                ...
                                queryBuilder: (chatsRecord) => chatsRecord
                                    .where(
                                      ...
                                      isEqualTo: getJsonField(
                                        ClientHomePageGroup.clientProfileCall
                                            .clientDetails(
                                          (_model.apiResultpy7?.jsonBody ?? ''),
                                        ),
                                        r'''$.service.user_id''',
                                  ...
                                  itemBuilder: (context, listViewIndex) {
                                    ...
                                    return Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          context.pushNamed(
                                            UserChatMessageWidget.routeName,
                                            queryParameters: {
                                              ...
                                              'name': serializeParam(
                                                listViewChatsRecord.clientName,
                                                ParamType.String,
                                              ),
