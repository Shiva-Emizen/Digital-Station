...
//                                     children: [
//                                       Text(
//                                         FFLocalizations.of(context).getText('g0hx8vrw' /* DS Categories */),
...
//                                         onTap: () async {
//                                           context.pushNamed(CategoryPageWidget.routeName);
//                                         },
//                                         child: Text(
//                                           FFLocalizations.of(context).getText('jvoomwde' /* View all */),
//                                           style: FlutterFlowTheme.of(context).bodyMedium.override(
//                                             fontFamily: 'primaryFont',
...
//                                     children: [
//                                       Text(
//                                         FFLocalizations.of(context).getText('laukp26z' /* Popular Services */),
//                                         style: FlutterFlowTheme.of(context).bodyMedium.override(
//                                           fontFamily: 'primaryFont',
//                                           color: Colors.black,
//                                           fontSize: 16.0,
...
//                                         highlightColor: Colors.transparent,
//                                         onTap: () async {
//                                           context.pushNamed(ViewAllPageWidget.routeName);
//                                         },
//                                         child: Text(
//                                           FFLocalizations.of(context).getText('d2skxp94' /* View all */),
//                                           style: FlutterFlowTheme.of(context).bodyMedium.override(
//                                             fontFamily: 'primaryFont',
//                                             color: Color(0xFF898989),
//                                             letterSpacing: 0.0,
...
//                                     child: Row(
//                                       mainAxisSize: MainAxisSize.max,
//                                       children: List.generate(pupularList.length, (pupularListIndex) {
//                                         final pupularListItem = pupularList[pupularListIndex];
//                                         return Material(
...
//                                     children: [
//                                       Text(
//                                         FFLocalizations.of(context).getText('wn65sjss' /* Recently viewed */),
//                                         style: FlutterFlowTheme.of(context).bodyMedium.override(
//                                           fontFamily: 'primaryFont',
//                                           color: Colors.black,
//                                           fontSize: 16.0,
...
//                                       ),
//                                       Text(
//                                         FFLocalizations.of(context).getText('tv53vz82' /* View all */),
//                                         style: FlutterFlowTheme.of(context).bodyMedium.override(
//                                           fontFamily: 'primaryFont',
//                                           color: Color(0xFF898989),
//                                           letterSpacing: 0.0,
...
//                                               valueOrDefault<String>(
//                                                 getJsonField(
//                                                   ClientHomePageGroup.clientProfileCall.clientDetails(
...
//                                           alignment: AlignmentDirectional(0.0, -1.0),
//                                           child: Padding(
//                                             padding: EdgeInsetsDirectional.fromSTEB(12.0, 14.0, 0.0, 0.0),
//                                             child: Column(
//                                               mainAxisSize: MainAxisSize.min,
...
//                                               children: [
//                                                 Text(
//                                                   FFLocalizations.of(context).getText('en144zqw' /* Welcome Back */),
//                                                   style: FlutterFlowTheme.of(context).bodyMedium.override(
//                                                     fontFamily: 'primaryFont',
//                                                     color: Colors.white,
//                                                     fontSize: 12.0,
...
//                                         fontStyle: FlutterFlowTheme.of(context).labelMedium.fontStyle,
//                                       ),
//                                       hintText: FFLocalizations.of(context).getText('r14e9dby' /* Search */),
...
//                     ],
//                   ),
//                 // ... Add the else block for other userType if needed ...
//               ],
//             ),
//           ),
//         );
